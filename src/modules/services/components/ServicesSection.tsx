...
export const ServicesSection = () => {
  ...
  return (
    <section id="services-catalog" className="bg-obsidian text-white py-16 md:py-24 lg:py-40 px-6 md:px-12 relative overflow-hidden font-sans border-t border-white/5">
